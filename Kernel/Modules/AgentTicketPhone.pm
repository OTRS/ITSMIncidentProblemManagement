...
# --
# $Id: AgentTicketPhone.pm,v 1.15.4.2 2012-08-20 17:02:51 ub Exp $
# $OldId: AgentTicketPhone.pm,v 1.113.2.6 2012/03/05 09:47:47 mg Exp $
# --
...
use vars qw($VERSION);
$VERSION = qw($Revision: 1.15.4.2 $) [1];
