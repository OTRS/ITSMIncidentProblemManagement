...
# --
# $Id: CustomerTicketZoom.pm,v 1.10.4.2 2012-08-20 17:02:51 ub Exp $
# $OldId: CustomerTicketZoom.pm,v 1.48.2.3 2011/11/02 18:12:47 jp Exp $
# --
...
use vars qw($VERSION);
$VERSION = qw($Revision: 1.10.4.2 $) [1];
