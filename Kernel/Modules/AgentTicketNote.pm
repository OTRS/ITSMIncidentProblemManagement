...
# --
# $Id: AgentTicketNote.pm,v 1.11.4.1 2011-02-11 13:37:39 ub Exp $
# $OldId: AgentTicketNote.pm,v 1.71.2.8 2010/07/21 05:45:32 mp Exp $
# --
...
use vars qw($VERSION);
$VERSION = qw($Revision: 1.11.4.1 $) [1];
