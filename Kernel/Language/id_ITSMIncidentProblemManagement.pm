...
sub Data {
    ...
    $Self->{Translation}->{'Change ITSM fields of ticket'} = 'ubah bidang ITSM tiket';
    ...
    $Self->{Translation}->{'Dynamic fields shown in the additional ITSM field screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'Bidang dinamis yang di tunjukan didalam layar bidang ITSM tambahan pada antarmuka agen. 0 = dinonaktifkan, 1 = di aktifkan, 2 = diaktifkan dan diperlukan.';
    $Self->{Translation}->{'Dynamic fields shown in the decision screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'Bidang dinamis yang di tunjukan didalam layar keputusan pada antarmuka agen. 0 = dinonaktifkan, 1 = di aktifkan, 2 = diaktifkan dan diperlukan.';
    $Self->{Translation}->{'Dynamic fields shown in the ticket search screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.'} =
        'Bidang dinamis yang di tunjukan didalam layar pencarian tiket pada antarmuka agen. 0 = dinonaktifkan, 1 = di aktifkan, 2 = diaktifkan dan diperlukan.';
    $Self->{Translation}->{'Dynamic fields shown in the ticket zoom screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.'} =
        'Bidang dinamis yang di tunjukan didalam layar pembesaran tiket pada antarmuka agen. 0 = dinonaktifkan, 1 = di aktifkan, 2 = diaktifkan dan diperlukan.';
